...
define(function(require, exports, module) {
    ...
    function initData() {
        ...
        //             if(this.RegionsListData.resultSet != null){
        //                 for(var i = 0;i< RegionsListData.resultSet.length;i++){
        //                     uls += '<li data-flag="china"><em>' + i18next.t(RegionsListData.resultSet[i].desc) + '</em></li>';
        //                 }
        //             }
        //             var html=''
    ...
    function initEvent() {
        ...
        //  *  关闭选择地区弹出框
        //  */
        $('.viewbox').on(end,'#areabox',function(){
            $('.pop-areabox').hide()
        });
    }
