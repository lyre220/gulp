                ...
                switch (name) {
                    case 'checkCode':
                        if (isNumberOnly(val) && val.length == 4) {
                            ...
                            pubPopup.noticeTis('请输校验码', 'setTransactionPwd.fillPersonalInfo'); //TODO
                            updateFlag = false;
                            return false;
                        }
                        break;
                ...
                ajaxdata.OperateRemote.setTransactionPwd.success = function (data) {
                    ...
                    switch (data.statusCode) {
                        ...
                        case 9006:
                            ...
                            break;
                        case 1001500:
                            pubPopup.noticeTis('操作失败', 'setTransactionPwd.tradePwdFail'); //TODO
                            break;
                        case 1002001:
                ...
                ajaxdata.OperateRemote.backTransactionPwd.success = function (data) {
                    ...
                    switch (data.statusCode) {
                        ...
                        case 9009:
                            ...
                            break;
                        case 1002001:
                            pubPopup.noticeTis('参数异常', 'common.submitDataError');//TODO
                            break;
                        case 1002015:
